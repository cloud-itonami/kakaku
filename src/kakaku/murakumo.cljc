...
(defn collection
  [name]
  (str "com.etzhayyim.kakaku." name))

(def cell-specs {
  :compareoffers {:legacy-cell "com-etzhayyim-apps-kakaku-compareOffers"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "compareoffers")]
     :required-gates common-gates
     :trigger "manifest cell compareoffers"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :product {:legacy-cell "com-etzhayyim-apps-kakaku-product"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "product")]
     :required-gates common-gates
     :trigger "manifest cell product"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :merchant {:legacy-cell "com-etzhayyim-apps-kakaku-merchant"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "merchant")]
     :required-gates common-gates
     :trigger "manifest cell merchant"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :offer {:legacy-cell "com-etzhayyim-apps-kakaku-offer"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "offer")]
     :required-gates common-gates
     :trigger "manifest cell offer"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pricehistory {:legacy-cell "com-etzhayyim-apps-kakaku-priceHistory"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pricehistory")]
     :required-gates common-gates
     :trigger "manifest cell pricehistory"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :matchcandidate {:legacy-cell "com-etzhayyim-apps-kakaku-matchCandidate"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "matchcandidate")]
     :required-gates common-gates
     :trigger "manifest cell matchcandidate"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
